...
public static class Offsets {
    ...
    public const Int64 ProcessTankUpdatePacket = 0xB43830; // incoming PACKET_* dispatcher
    public const Int64 VariantListSerializeFromMem = 0x128CEE0; // VariantList::SerializeFromMem
    public const Int64 PacketTypeDispatcher = 0xA166B0; // 
    public const Int64 PacketLengthValidator = 0xC43550; // 
    public const Int64 TrackPacketSender = 0xB78A80; // 
    public const Int64 ENetHostConnectSetup = 0xA16290; // 
    public const Int64 PlayerItems_AddItem = 0xC4B3C0; // 
    public const Int64 PlayerItems_HaveRoomForItem = 0xC4C550; // 
    public const Int64 PlayerItems_RemoveItem = 0xC4DCD0; // 
    public const Int64 InventoryIllegalItemPurge = 0xC4DE20; // 
    public const Int64 ItemsDatLoader = 0xC62340; // 
    public const Int64 ItemValidator = 0xC61DE0; // 
    public const Int64 ItemHashCheck = 0xC33B00; // 
    public const Int64 ItemSurfaceRender = 0xA47B60; // 
    public const Int64 ChooseVisual = 0xC827C0; // 
    public const Int64 World_Load = 0x145F590; // 
    public const Int64 WorldVersionCheck = 0xB43830; // 
    public const Int64 TileExtraParser = 0xC73C90; // 
    public const Int64 WhiteDoorLookup = 0x145ED90; // 
    public const Int64 TilesheetLoader = 0xA36DA0; // 
    public const Int64 BgItemMapValidator = 0xC62B80; // 
    public const Int64 NetAvatar_OnAvatarBePaintBalled = 0xAEF750; // 
    public const Int64 PunchHackDetector = 0xAF4250; // 
    public const Int64 PunchNoTileHandler = 0x9B4BD0; // 
    public const Int64 HarvestInteraction = 0xA1F3A0; // 
    public const Int64 CameraManager = 0xA331D0; // 
    public const Int64 DialogBuilder = 0xCFD640; // 
    public const Int64 BannerDialogBuilder = 0xD775D0; // 
    public const Int64 EnableAllButtonsEntity = 0x11E2FB0; // 
    public const Int64 Controller_PushController = 0xD8CCF0; // 
    public const Int64 Controller_PopController = 0xD8CAD0; // 
    public const Int64 Controller_PushChildController = 0x1091B70; // 
    public const Int64 Controller_OnActivate = 0xDC8120; // 
    public const Int64 Controller_Deactivate = 0xDC7D60; // 
    public const Int64 Controller_Release = 0x989460; // 
    public const Int64 UIController_OnActivate = 0x10E5E20; // 
    public const Int64 UIController_OnDeactivate = 0x10E6410; // 
    public const Int64 UIController_RemoveScreenView = 0x10E6690; // 
    public const Int64 ParticleEmitter_GetPaintballColor = 0xE174B0; // 
    public const Int64 RTFont_GetColorFromString = 0xD64BB0; // 
    public const Int64 ResourceManager_GetSurfaceResource = 0x1254790; // 
    public const Int64 VideoModeManager_SetVideoMode = 0xDB7580; // 
    public const Int64 VideoModeManager_SetFullscreen = 0xDB6E90; // 
    public const Int64 VideoModeManager_AddVideoMode = 0xDB47C0; // self-naming anchor: AddVideoMode logs its own name once; a 5
    public const Int64 VideoModeManager_GetCustomVideoModes = 0xDB4D80; // 
    public const Int64 VideoModeManager_OnWMSize = 0xDB6F60; // 
    public const Int64 IAPManager_LoadCurrenciesConfig = 0x11A8880; // 
    public const Int64 IAPManager_ctor = 0x11B49B0; // 
    public const Int64 App_Kill = 0x988410; // 
    public const Int64 StoreBuyPacketPath = 0xD738A0; // 
    public const Int64 TileCoordinateHandler = 0x9B3180; // 
    public const Int64 LogDisplayEntityBuilder = 0x11E6BA0; // NOT LogToConsole: the sole owner of this string also refs Ge
    public const Int64 ItemRendererXmlLoader = 0xFD4C00; // parses GameData/ItemRenderers/*.xml: ItemRenderer/StateMachi
    public const Int64 BattlePetConfigLoader = 0xBCE510; // 
    public const Int64 OwlsOfAthenaPets_RenderPet = 0x779E70; // 
    public const Int64 Flying2Pets_RenderPet = 0x8EFCE0; // 
    public const Int64 Scepter_RenderPet = 0x6A24E0; // 
    public const Int64 OwlsOfAthenaPets_OnRespawned = 0x764F80; // 
    public const Int64 Flying2Pets_OnRespawned = 0x8DA8F0; // 
    public const Int64 FactionIconLoader = 0xAE9D90; // 
    public const Int64 PlayerProgression = 0x16AC4F0; // 
    public const Int64 TextOverlayActionHandler = 0xB401A0; // msg|/file|/imageFile|/delayMS| overlay+audio handler
    public const Int64 InventoryTabUI = 0x10B4B60; // growid|/tabblocks|/tabseeds|/taball| inventory tabs
    public const Int64 CaptchaInputDialog = 0xD0CA90; // 
    public const Int64 AuthClient_Login = 0x16C1820; // 
    public const Int64 WorldTileMap = 0xC8A060; // the tile-map container: dimensions + tile count
    public const Int64 TileLookupGuard = 0x9CA590; // tile lookup / punch target resolution
    public const Int64 TilesheetPageLoader = 0xD0EE40; // tile sheet texture loader
    public const Int64 WorldValidation = 0x10FC3E0; // world validation pass
    public const Int64 WeaponDamageTierText = 0xC10EA0; // weapon damage tier description
    public const Int64 GrowtorialButton = 0xCC21F0; // 
    public const Int64 WorldLockText = 0xAFB5C0; // 
    public const Int64 SeedTreeItemPath = 0xCED4B0; // 
    public const Int64 TileDefinitionsLoader = 0xC2F070; // 
    public const Int64 WeatherEffectText = 0xC085F0; // 
    public const Int64 ItemEffectVariantDispatcher = 0xB041D0; // second On* dispatcher (43 handlers): item/cosmetic effect va
    public const Int64 OnDeathEquipTagHandler = 0xFDB570; // also OnEquipTag; death + equip-tag handling
    public const Int64 OnDisconnectedHandler = 0xB39300; // 
    public const Int64 OnErrorFinishHandler = 0xA758B0; // also OnFinish
    public const Int64 OnOverMoveHandler = 0x11BF6E0; // also OnOverEnd; hover/drag move
    public const Int64 OnEventHandler = 0x106C640; // 
    public const Int64 OnRenderHandler = 0x12338F0; // 
    public const Int64 OnFakeScrollToEntity = 0x1225920; // 
    public const Int64 OnDeleteHandler = 0x17178A0; // 
    public const Int64 OnButtonSelectedHandler = 0xD12740; // 
    public const Int64 TradeHandler = 0xD87450; // 
    public const Int64 TradeOtherPlayerGuard = 0xD85D10; // 
    public const Int64 StateMachineTransitions = 0x1034EC0; // item-renderer state-machine transitions
    public const Int64 AnimCurveKeyFrameParser = 0x1010E20; // animation curve/keyframe parser
    public const Int64 SpriteAnimStateParser = 0x1017DC0; // sprite animation: playOnState/isLoop
    public const Int64 AnimTimeParser = 0x1012910; // 
    public const Int64 ParticleEmitterParser = 0xE174B0; // particle emitter definitions
    public const Int64 RendererConditionParser = 0x1037300; // state-machine <Condition> evaluation
    public const Int64 SpriteRenderParser = 0x8E04B0; // 
    public const Int64 LoginPacketBuilder = 0xDCA460; // 
    public const Int64 TileActionBuilder = 0xAF66C0; // 
    public const Int64 DialogButtonBuilder = 0x10F4D40; // 
    public const Int64 NetAvatarSpawnHandler = 0xB3E690; // 
    public const Int64 GameUpdatePacketSerializer = 0xA187E0; // 
    public const Int64 NetAvatarNetIDEmitter = 0xB3BB10; // 
    public const Int64 IAPPurchaseValidation = 0xD22F70; // 
    public const Int64 OnVariantDispatcher = 0xB32C90; // 
    public const Int64 PunchAction = 0xDE5970; // 
    public const Int64 GetApp = 0x984F70; // leaf without unwind data; not a .pdata entry
    public const Int64 GetClient = 0xA16270; // kAppClientOffset = 0xB10 (derived)
    public const Int64 GetPacketProcessor = 0xB2D9D0; // kAppPacketProcessorOffset = 0x1258 (derived)
    public const Int64 GetLocalAvatar = 0xB2DBA0; // kPacketProcessorLocalAvatarOffset = 0x1D0 (derived)
